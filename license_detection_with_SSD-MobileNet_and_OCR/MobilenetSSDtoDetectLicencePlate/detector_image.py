...
# IMAGE = r"C:\Users\bensc\Projects\license_plate\Mobilenet-SSD-to-detect-Licence-Plate\data\license_plate_images\Cars104.png"
#
...
def detect(IMAGE, PBTXT="models//label_map.pbtxt",
           MODEL="models//exported-models-V2//my_model//saved_model",
           visualize=False):
    ...
    image_np_with_detections[int(height * 0.05):int(height * 0.05 + pl_height),
    int(height * 0.05):int(height * 0.05 + pl_width)] = plate
